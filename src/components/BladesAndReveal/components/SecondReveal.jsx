...
export const SecondReveal = ({ scrollProgress, isVisible }) => {
  ...
  const firstImage = scrollProgress >= 0.35 && scrollProgress < 0.6;
  const secondImage = scrollProgress >= 0.37 && scrollProgress < 0.6;
  const firstText = scrollProgress >= 0.39 && scrollProgress < 0.45;
  const secondText = scrollProgress >= 0.39 && scrollProgress < 0.45;
  const thirdText = scrollProgress >= 0.39 && scrollProgress < 0.45;
      ...
      <AnimatePresence mode="wait">
          { firstImage && showModal && (
            ...
            >
              ...
              <video src="/video3.mp4" style={{zIndex:-20,width:"100%",height:"100%",objectFit:"cover"}} autoPlay loop muted>
                ...
                >
                  ...
                  >
                    <strong style={{ lineHeight: 3 }}>
                      Crea tecnología que innove.
                    </strong>
                    <br />
                    Además de interfaces para webs y apps, creamos flujos de
                    navegación, prototipos, UX writing, arquitectura de la
                    información y optimización de procesos.
                  </p>
                </div>
              </motion.div>
            )}
...
SecondReveal.displayName = "SecondReveal";